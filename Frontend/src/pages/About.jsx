      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          ...
          <p className="text-gray-800">
            ...
            repudiandae esse suscipit expedita veniam in dicta vel. Quae atque
            facere blanditiis consectetur, saepe beatae eum deleniti porro error
            labore accusamus dolores, inventore ab.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row text-sm mb-20">
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          ...
          <p className="text-gray-600">
            ...
            maxime dolorum placeat, eaque voluptatibus nisi autem blanditiis est
            rerum consequuntur.
          </p>
        </div>
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          <b>Convenience</b>
          <p className="text-gray-600">
            Lorem ipsum dolor sit amet, consectetur adipisi est rerum
            consequuntur.
          </p>
        </div>
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          ...
          <p className="text-gray-600">
            ...
            consectetur adipisicing elit. Eveniet necessitatibus laudantium
            molestias ducimus sunt excepturi a nisi unde recusandae
            dolorem.adipisi est rerum consequuntur.
          </p>
        </div>
      </div>
